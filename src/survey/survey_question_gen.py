...
names = ["Alex", "Jamie", "Taylor", "Jordan",
         ...
         "Skyler", "Cameron", "Dakota", "Emerson",
         "Finley", "Rowan", "Reese", "Peyton",
         "Sage", "Remy", "Blake", "Drew",
         "Avery", "Elliot", "Hayden", "Micah",
         "Emery", "Tatum", "Spencer", "Arden",
         "Lennon", "Kai", "Shiloh", "Blair",
         "River", "Noel", "Sasha", "Sky",
         "Terry", "Jules", "Cory", "Frankie",
         "Gray", "Indigo", "Luca", "Oakley",
         "Robin", "Charlie", "Dallas", "Winter",
         "Ocean", "Leslie"]
...
def generate_aggregate_sentiment_sentences(used_objects):
    ...
    seq2 = [y2, x2, x2, y2, y2]
    marks5 = ["Once", "Soon after", "For a while", "Recently", "Now"]
    sents2, descs2, ints2 = [], [], []
